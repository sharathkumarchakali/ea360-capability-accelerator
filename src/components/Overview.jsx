        ...
        <div className="executive-band">
          <div className="executive-message">
            ...
            <div className="hero-chips">
              <span className="hero-chip">12 domains</span>
              <span className="hero-chip">126 evidence</span>
              <span className="hero-chip">04 Sep 2026</span>
            </div>
          </div>
          <div className="maturity-card">
            <div className="maturity-gauge" style={{ '--value': 46 }}>
